...
func TestLoadTestConfig(t *testing.T) {
	...
	if cfg.Database.Name != "agentstore-test" {
		t.Errorf("expected database name 'agentstore-test', got %q", cfg.Database.Name)
	}
...
func TestGetEnvCustom(t *testing.T) {
	os.Setenv("AGENTSTORE_ENV", "staging")
	defer os.Unsetenv("AGENTSTORE_ENV")
